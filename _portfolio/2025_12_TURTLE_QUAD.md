---
title: TURTLE Robotics Quadruped (QUAD)
excerpt: A series of quadrupedal robots developed with TURTLE Robotics at Texas A&M University<br/><img src='/images/QUAD/QUAD_V2.png' style='height:300px'/>
collection: portfolio
---

| ![Mini QUAD V0](/images/QUAD/Mini_QUAD_V0.png) | ![QUAD V1](/images/QUAD/QUAD_V1.png) | ![Mini QUAD V1](/images/QUAD/Mini_QUAD_V1.png) | ![QUAD V2](/images/QUAD/QUAD_V2.png) |
| :--------------------------------------------: | :----------------------------------: | :--------------------------------------------: | :----------------------------------: |
|           *Mini QUAD V0 (Fall 2022)*           |        *QUAD V1 (Fall 2023)*         |           *Mini QUAD V1 (Fall 2024)*           |        *QUAD V2 (Fall 2025)*         |
